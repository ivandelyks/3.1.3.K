...
public class CommandLineRunnerImp implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        User adminUser = new User("Ivan", passwordEncoder.encode("100"), "ivan@mail.ru");
        User user1 = new User("Maxim", passwordEncoder.encode("100"), "maxim@mail.ru");
        User user2 = new User("Dima", passwordEncoder.encode("100"), "dima@mail.ru");
